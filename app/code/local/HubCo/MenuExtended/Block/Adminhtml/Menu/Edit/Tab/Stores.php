 ...
 */
class HubCo_MenuExtended_Block_Adminhtml_Menu_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return HubCo_MenuExtended_Block_Adminhtml_Menu_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
