 ...
 */
/**
 * Menu admin grid block
 *
 * @category    HubCo
 * @package     HubCo_MenuExtended
 * @author      Ultimate Module Creator
 */
class HubCo_MenuExtended_Block_Adminhtml_Menu_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
    ...
    {
        $collection = Mage::getModel('hubco_menuextended/menu')
            ->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'url_key',
            array(
                'header' => Mage::helper('hubco_menuextended')->__('URL key'),
                'index'  => 'url_key',
            )
        );
     ...
     *
     * @access public
     * @param HubCo_MenuExtended_Model_Menu
     * @return string
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access protected
     * @param HubCo_MenuExtended_Model_Resource_Menu_Collection $collection
