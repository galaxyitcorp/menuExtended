 ...
 */
/**
 * Menu comments resource collection model
 *
 * @category    HubCo
 * @package     HubCo_MenuExtended
 * @author      Ultimate Module Creator
 */
class HubCo_MenuExtended_Model_Resource_Menu_Comment_Menu_Collection extends HubCo_MenuExtended_Model_Resource_Menu_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('hubco_menuextended/menu_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.menu_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('hubco_menuextended/menu_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.menu_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
